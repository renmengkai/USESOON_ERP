...
CREATE TABLE `erp_purchase` (
  `id` varchar(36) NOT NULL COMMENT '主键ID',
  `purchase_no` varchar(255) DEFAULT NULL COMMENT '采购编号',
  ...
  `cost_price` decimal(10,2) DEFAULT NULL COMMENT '采购成本价',
  `purchase_date` datetime DEFAULT NULL COMMENT '采购日期',
  `is_valid` varchar(255) DEFAULT NULL COMMENT '采购状态：0否1是',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注信息',
  `tenant_id` varchar(255) DEFAULT NULL COMMENT '租户ID',
  `opter` varchar(255) DEFAULT NULL COMMENT '操作人编号',
  `opter_name` varchar(255) DEFAULT NULL COMMENT '操作人姓名',
...
CREATE TABLE `erp_stock` (
  ...
  `warehouse` varchar(255) DEFAULT NULL COMMENT '仓库名称',
