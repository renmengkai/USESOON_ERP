...
enum Api {
  ...
  ruleList = '/erp/order/queryPermissionRule',
  ruleSave = '/erp/order/addPermissionRule',
  ruleEdit = '/erp/order/editPermissionRule',
  ruleDelete = '/erp/order/deletePermissionRule',
  checkPermDuplication = '/erp/order/checkPermDuplication',
}
 ...
 * @param params
 */
export const ajaxGetDictItems = (params) => defHttp.get({ url: `/erp/dict/getDictItems/${params.code}` });
